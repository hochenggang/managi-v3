...
- **多平台**：后端 Go 静态二进制（Linux/macOS/Windows, glibc/musl），前端单 HTML 文件，桌面端 Tauri
...
[下载客户端](https://github.com/hochenggang/managi-v3/releases)（Windows）

### 手动运行

```bash
# 下载二进制
wget -O /usr/local/bin/managi https://github.com/hochenggang/managi-v3/releases/latest/download/managi-linux-amd64
chmod +x /usr/local/bin/managi
